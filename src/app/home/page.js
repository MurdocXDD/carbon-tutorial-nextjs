      ...
      <Column lg={16} md={8} sm={4} className="landing-page__r3">
        <InfoSection heading="The Principles">
          ...
          <InfoCard
            ...
            body="Carbon is built upon IBM Design Language, which provides a unified approach to design. Every element and component of Carbon was designed from the ground up to work elegantly together to ensure consistent, cohesive user experiences."
